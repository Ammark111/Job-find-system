...
@include('layout.footer')
    <div class="">
        <div class="body">
            <div class="container ">
                <h3 class="mt-5`">Jobs Details</h3>
                <hr>
                <div class="detail mt-3" style="background-color: white;">
                        <div class="button d-flex justify-content-end align-items-center" style="height: 3em;">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                    <div class="offcanvas-header">
                        <h5 id="offcanvasRightLabel">Add New Job Post</h5>
                    ...
                    <div class="offcanvas-body">
                        <form action="{{ route('job')}}" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label"><b>Job Name</b></label>
                                <select name="job" id="" class="form-control">
                                    <option value="Accounting and Auditing">Accounting and Auditing</option>
                                    <option value="Banking, Economics and Financial Services">Banking, Economics and Financial Services</option>
                                    ...
                                    <option value="Environmental Sciences and GeographyFarming and Livestock">Environmental Sciences and GeographyFarming and Livestock</option>
                                    <option value="Farming and Livestock">Farming and Livestock</option>
                                    <option value="Healthcare and Pharmaceutical">Healthcare and Pharmaceutical</option>
                                    <option value="HR & AdministrationInternational Relations">HR & AdministrationInternational Relations</option>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="position" placeholder="Enter Number Of Position">
                            </div>
