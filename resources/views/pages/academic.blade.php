...
@section('content')
    ...
    <div class="contain">
        <div class="body">
            <div class="container">
                <h3 class="ps-4">Accademic Qualification Details</h3>
                <hr>
                        ...
                        <div class="container">
                            <table class="table table-striped table-hover mt-4">
                                ...
                                <tbody>
                                    <tr>
                                        <td>{{$counter}}</td>
                                        <td>{{$academ -> institute_name}}</td>
                                        <td>{{$academ -> level}}</td>
                                        <td>{{$academ -> program}}</td>
                                        <td>{{$academ -> country}}</td>
                                        <td>{{$academ -> year}}</td>
                                        <td>Not yet</td>
                                        <td>
                                            <div class="d-flex" style="height: 30px;">
                                                <div class="bg-primary">
                                                    <a href="" class="btn btn-primary" style="height: 30px;" data-bs-toggle="offcanvas" aria-controls="offcanvasRight" data-bs-target="#editoffcanvasRightacademic_{{ $academ->id }}">
                                                ...
                                                <div class="bg-danger">
                                                    <a href="{{ url('deleteacademic/'.$academ->id)}}" class="btn btn-danger" style="height: 30px;">
