    ...
    <div class="contain">
        <div class="body">
            <div class="container mt-5">
                <h3 class="mt-5`">Computer Literacy Details</h3>
                <hr>
                        ...
                        <div class="container">
                            <table class="table mt-4">
                                <thead>
                                    <tr>
                                        <th class="p-3">#</th>
                                        <th class="p-3">Computer Skills</th>
                                ...
                                <tbody>
                                        ...
                                        <td>
                                            <div class="d-flex" style="height: 30px;">
                                                <div class="bg-primary">
                                                    <a href="" class="btn btn-PRIMARY" style="height: 30px;" data-bs-toggle="offcanvas" aria-controls="offcanvasRight" data-bs-target="#editoffcanvasRight_{{ $comp->id }}">
                                                ...
                                                <div class="bg-danger">
                                                    <a href="{{ url('deletecomputer/'.$comp->id)}}" class="btn btn-danger" style="height: 30px;">
                                    ...
                                    @php 
                                        $id ++;
                                    @endphp
                                    @include('pages.edit.editcomputer')
                                    @endforeach
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                    <div class="offcanvas-header">
                        <h5 id="offcanvasRightLabel">Add computer literacy</h5>
                    ...
                    <div class="offcanvas-body">
                        <form action="{{ route('computer')}}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="radio" name="level" value="Very Good" class="me-2"><span>Very Good</span>
                                <input type="radio" name="level" value="Good" class="me-2"><span>Good</span>
                                <input type="radio" name="level" value="Fair" class="me-2"><span>Fair</span>
                            </div>
                            <div class="mb-3">
